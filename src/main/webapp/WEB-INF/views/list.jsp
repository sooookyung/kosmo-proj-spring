...
<body>
    <div class="login-body">
        <div class="login-content"> 
            ...
            <input type="hidden" name="csrfmiddlewaretoken" value="hYuKP8jAUKrwgQYkC41ayCRLbPEGcnfbZPSBEXLJxqIAwviUQEnBFI2GQJ22BmKF">
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse4" class="accordion-collapse collapse" aria-labelledby="heading4" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('IDLE', '2', '4')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse1" class="accordion-collapse collapse" aria-labelledby="heading1" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('Bang SOFT', '1', '1')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse9" class="accordion-collapse collapse" aria-labelledby="heading9" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('Tuna Salad', '3', '9')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse10" class="accordion-collapse collapse" aria-labelledby="heading10" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                2023. 02. 22 ~ 2023. 03. 20<br><br>
                                <button style="display:block-inline" onclick="check_apply('Fantastic 4', '4', '10')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse3" class="accordion-collapse collapse" aria-labelledby="heading3" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('Bang SOFT', '1', '3')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse5" class="accordion-collapse collapse" aria-labelledby="heading5" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('IDLE', '2', '5')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse12" class="accordion-collapse collapse" aria-labelledby="heading12" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('Fantastic 4', '4', '12')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse2" class="accordion-collapse collapse" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('Bang SOFT', '1', '2')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse7" class="accordion-collapse collapse" aria-labelledby="heading7" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('Tuna Salad', '3', '7')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse8" class="accordion-collapse collapse" aria-labelledby="heading8" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                2023. 03. 02 ~ 2023. 04. 03<br><br>
                                <button style="display:block-inline" onclick="check_apply('Tuna Salad', '3', '8')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse11" class="accordion-collapse collapse" aria-labelledby="heading11" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                2023. 03. 02 ~ 2023. 04. 03<br><br>
                                <button style="display:block-inline" onclick="check_apply('Fantastic 4', '4', '11')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="heading6" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('IDLE', '2', '6')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse13" class="accordion-collapse collapse" aria-labelledby="heading13" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('TN World Legend Bomi', '5', '13')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse14" class="accordion-collapse collapse" aria-labelledby="heading14" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                2023. 02. 22 ~ 2023. 05. 31<br><br>
                                <button style="display:block-inline" onclick="check_apply('TN World Legend Bomi', '5', '14')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="accordion-item">
                        ...
                        <div id="collapse15" class="accordion-collapse collapse" aria-labelledby="heading15" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                ...
                                <button style="display:block-inline" onclick="check_apply('TN World Legend Bomi', '5', '15')">지원하기</button><br><br>
                            </div>
                        </div>
                    </li>
